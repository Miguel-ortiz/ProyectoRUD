                ...
                <fieldset class="form-fieldset PaginarTabla">                
                    ...
                    <div class="form-group col-sm-3">
                        <div class="input-group" >
                            ...
                            <select class="form-control" id="tipoeven_sel" name="tipoeven_sel"  readonly>
                ...
                <fieldset class="form-fieldset">
                    <table style="margin: auto; text-align: center; " class="table table-bordered table-hover" cellspacing="1" cellpadding="0" border="1" id="tab2">
                            ...
                            <tbody style="text-align: center">
                                ...
                                <c:forEach var="bienesAfectadosRUDVO" items="${bienesAfectadosRUDVO}"  varStatus="i">
                                    <tr>
                                        <td style="text-align: center;"></td> 
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.biaf_municipio}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.regi_id}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.tuvi_id}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.ttvi_id}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.biaf_corregimiento}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.biaf_vereda}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.biaf_sector}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.biaf_barrio}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.biaf_direccion}</td>
                                        <td style="color: ${color}">${bienesAfectadosRUDVO.tpaf_id}</td>
