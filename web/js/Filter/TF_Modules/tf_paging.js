...
=====================================================*/
{
	...
	this.btnNextPageHtml =		f.btn_next_page_html!=undefined //defines next page button html
									...
									'<input type="button" value="" class="'+this.btnPageCssClass+' nextPage" title="P&aacute;gina Siguente" />'); 
	this.btnPrevPageHtml =		f.btn_prev_page_html!=undefined //defines previous page button html
									...
									'<input type="button" value="" class="'+this.btnPageCssClass+' previousPage" title="P&aacute;gina Anterior" />'); 
	this.btnFirstPageHtml =		f.btn_first_page_html!=undefined //defines last page button html
									...
									'<input type="button" value="" class="'+this.btnPageCssClass+' firstPage" title="Primera P&aacute;gina" />'); 
	this.btnLastPageHtml =		f.btn_last_page_html!=undefined //defines previous page button html
									...
									'<input type="button" value="" class="'+this.btnPageCssClass+' lastPage" title="Ultima P&aacute;gina" />');
	this.pageText =				f.page_text!=undefined ? f.page_text : ''; //defines text preceeding page selector drop-down
	this.ofText =				f.of_text!=undefined ? f.of_text : ' de '; //defines text after page selector drop-down 
