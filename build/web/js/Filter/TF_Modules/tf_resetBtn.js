...
=====================================================*/
{
	...
	this.btnResetText =			f.btn_reset_text!=undefined ? f.btn_reset_text : 'Reseteo'; //defines reset text
	this.btnResetTooltip =		f.btn_reset_tooltip!=undefined ? f.btn_reset_tooltip : 'Limpiar B&uacute;queda'; //defines reset button tooltip
